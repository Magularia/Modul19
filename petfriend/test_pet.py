...
def test_successful_update_self_pet_info(name='Кингконг', animal_type='бонобо', age=3):
...
def test_successful_set_pet_photo(pet_photo='images/pomeranian.jpeg'):
    pet_photo = os.path.join(os.path.dirname(__file__), pet_photo)
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Гуппи", "рыба", "3", "images/fish.jpeg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
